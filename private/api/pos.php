...
$api_url =  DOMAIN_PATH."pos.php";

$db_columns =  "amount,  tracking_no, date_only, time_only, user_id   ";
  $ch = curl_init();
...
foreach ($user_array as $innerArray) {
    ...
    if (is_array($innerArray)){
          ...
          $sql .= "'".Mike::e($innerArray['amount'])."', ";

          $sql .= "'".Mike::e($innerArray['tracking_no'])."', ";

          $sql .= "'".Mike::e($innerArray['date_only'])."', ";

          $sql .= "'".Mike::e($innerArray['time_only'])."', ";

          $sql .= "'".Mike::e($innerArray['user_id'])."' ";
