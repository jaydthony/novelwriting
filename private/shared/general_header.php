...
<html lang="en">
  ...
  <body>
    <header class="header header--loggedIn">
      <div class="container">
        <a href="<?php print Whiz::url_for("/") ?>" class="header__logo">
          <img src="<?php print Whiz::url_for("assets/images/logos/" . $siteinfo->logo)?>" />
          <h1><?php print $siteinfo->company_name ?></h1>
        </a>
        <form class="header__search">
          <label>
            ...
            <input placeholder="Search by Tags/Story name/Username" name="q" />
          </label>
        </form>
        <nav class="header__menu">
          ...
          <?php if($logged_user) : ?>
            ...
            <a href="<?php print Whiz::url_for("profile?id=".$logged_user->id) ?>">
              <div class="avatar avatar--medium active">
                <img src="<?php print Whiz::url_for("/assets/images/profile/".$logged_user->file) ?>"/>
              </div>
              <p><?php print $logged_user->fullname ?><span><?php print $logged_user->username ?></span></p>
            </a>
          ...
          <div class="dropdown-menu">
            <a href="<?php print Whiz::url_for("settings?id=".$logged_user->id) ?>" class="dropdown-link"
              ><svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                <title>tools</title>
                <path
              ...
              Settings</a
            >
            <?php if ($logged_user->username == "gm") : ?>
            <a href="<?php print Whiz::url_for("config/users/") ?>" class="dropdown-link"
              >
              Config</a
            >
            <?php endif; ?>
            <a href="<?php print Whiz::url_for("logout") ?>" class="dropdown-link"
              ><svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
         ...
         <a href="<?php print Whiz::url_for("login") ?>"><img src="<?php print Whiz::url_for("assets/avatar.svg") ?>" /><p><span>Explore?</span> Login</p></a>
    ...
    <div class="container"><?php print Whiz::display_session_message(); ?></div>