        ...
        <div class="roomList">
          <div class="mobile-menu">
            <form class="header__search" action="<?php print Whiz::url_for("/") ?>">
              <label>
            ...
            <div class="mobile-menuItems">
              <a class="btn btn--main btn--pill" href="<?php print Whiz::url_for("genres") ?>">Browse Genres</a>
              <a class="btn btn--main btn--pill" href="<?php print Whiz::url_for("activities") ?>">Recent Activities</a>
            </div>
          </div>
          <div class="roomList__header">
            <div>
              <h2>Story Room</h2>
              <p><?php print count(Story::search_story($q)) ?> stories available</p>
            </div>
            <?php if($logged_user) : ?>
            <a class="btn btn--main" href="<?php print Whiz::url_for("create-story") ?>">
              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                <title>add</title>
                <path
          ...
          <?php foreach (Story::search_story($q) as $key): 
          ...
          <div class="roomListRoom">
            ...
            <div class="roomListRoom__meta">
              <a href="<?php print Whiz::url_for("room?id=".$key->id) ?>" class="roomListRoom__joined">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                ...
                print count(Paragraph::find_by_story_id($key->id))
